...
[ "$CUSTOM_CALLS" -gt 0 ] || fail "no unified modal coverage remains"
echo "PASS:"
...
echo "- unified modal coverage: $CUSTOM_CALLS current call sites"
echo "- dedicated full-screen screens may legitimately reduce the historical count"
