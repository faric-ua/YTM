...
grep -q 'versionCode = 84' app/build.gradle.kts \
  || fail "Expected versionCode = 84"

grep -q 'versionName = "1.4.44-R1"' app/build.gradle.kts \
  || fail 'Expected versionName = "1.4.44-R1"'
