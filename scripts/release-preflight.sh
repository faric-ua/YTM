...
grep -q 'versionCode = 81' app/build.gradle.kts \
  || fail "Expected versionCode = 81"

grep -q 'versionName = "1.4.42-R1"' app/build.gradle.kts \
  || fail 'Expected versionName = "1.4.42-R1"'
