...
grep -q 'versionCode = 78' app/build.gradle.kts \
  || fail "Expected versionCode = 78"

grep -q 'versionName = "1.4.41-R1"' app/build.gradle.kts \
  || fail 'Expected versionName = "1.4.41-R1"'
