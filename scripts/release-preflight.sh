...
grep -q 'versionCode = 73' app/build.gradle.kts \
  || fail "Expected versionCode = 73"

grep -q 'versionName = "1.4.38-R1"' app/build.gradle.kts \
  || fail 'Expected versionName = "1.4.38-R1"'
