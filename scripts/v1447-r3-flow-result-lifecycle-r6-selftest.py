...
APPLY = ROOT / "scripts/apply-v1447-r3-flow-result-lifecycle-r6.py"
...
def fixture():
    root = Path(tempfile.mkdtemp(prefix="ytm-r6-flow-"))
    grouped = {}
    for op in OPS:
...
def main():
    ...
    output = run(dup, "--check", expect=1).stdout
    ...
    print("PASS: R6 selftest complete")
