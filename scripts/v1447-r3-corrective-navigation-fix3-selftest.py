...
APPLY = ROOT / "scripts/apply-v1447-r3-corrective-navigation-fix3.py"
...
def fixture():
    root = Path(tempfile.mkdtemp(prefix="ytm-r3-nav-fix3-"))
...
def main():
    ...
    print("PASS: corrective navigation FIX3 selftest complete")
