...
APPLY = ROOT / "scripts/apply-v1447-r3-navigation-ownership-r4-fix2b.py"
...
def fixture():
    root = Path(tempfile.mkdtemp(prefix="ytm-r4-fix2b-"))
    target = root / "scripts/v1447-r3-navigation-ownership-r4-fix2-audit.sh"
...
def main():
    ...
    text = (
        root / "scripts/v1447-r3-navigation-ownership-r4-fix2-audit.sh"
    ...
    dup = fixture()
    p = dup / "scripts/v1447-r3-navigation-ownership-r4-fix2-audit.sh"
    p.write_text(
    ...
    print("PASS: R4 FIX2B selftest complete")
