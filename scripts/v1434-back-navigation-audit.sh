...
for f in "$UI" "$DRAWABLE" "$GRADLE"   docs/v.1.4.34/RELEASE.md   docs/v.1.4.34/REGRESSION_CHECKLIST.md   docs/v.1.4.34/qa/PHONE_TEST.md   docs/v.1.4.34/qa/BUG_REGISTER.md
do
  test -f "$f" || fail "missing v1.4.34 file: $f"
done

grep -Fq 'versionCode = 68' "$GRADLE" || fail "versionCode 68 missing"
grep -Fq 'versionName = "1.4.34"' "$GRADLE" || fail "versionName 1.4.34 missing"
