...
APPLY = ROOT / "scripts/apply-v1447-r3-corrective-navigation-fix6.py"
...
def fixture():
    root = Path(tempfile.mkdtemp(prefix="ytm-r3-nav-fix6-"))
...
def main():
    ...
    if "workflowRelayActive" in text:
        raise SystemExit("FAIL: stale symbol remains after apply")
    if NEW not in text:
        raise SystemExit("FAIL: replacement missing after apply")
    print("PASS: exact compile-fix replacement")
    ...
    print("PASS: corrective navigation FIX6 selftest complete")
