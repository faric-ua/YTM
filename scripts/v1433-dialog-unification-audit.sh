...
[ "$TOTAL" -gt 0 ] || fail "no unified modal call sites remain"
...
echo "- unified modal pipeline remains active: $TOTAL call sites"
echo "- later full-screen migrations may legitimately reduce modal call count"
