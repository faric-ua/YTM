...
APPLY = ROOT / "scripts/apply-v1447-r3-navigation-ownership-r4.py"
...
def fixture():
    root = Path(tempfile.mkdtemp(prefix="ytm-r4-selftest-"))
    grouped = {}
    for op in OPS:
...
def main():
    ...
    print("PASS: R4 navigation ownership package selftest complete")
