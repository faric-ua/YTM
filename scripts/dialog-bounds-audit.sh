...
echo "- shared fix covers all $CUSTOM_CALLS currently active unified modal call sites"
echo "- full-screen storage/list/utility migrations may legitimately reduce this count"
