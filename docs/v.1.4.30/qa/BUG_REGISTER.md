...
| BUG-007 / Q-007 | R2 FIX IMPLEMENTED — RETEST NEEDED | P3 | R1 short folder names passed, but `Створити backup` still wrapped and made dialog actions different heights; R2 uses one-word `Створити`. |
