# YTM Importer v1.0.0-rc3.1 — Regression checklist
...
- [ ] GitHub Actions `compileReleaseKotlin` проходить.
- [ ] Data dialog відкривається без crash.
- [ ] Текст про Full Backup / History JSON показується нормально.
- [ ] RC3 backup → restore → rollback flow не змінився.
