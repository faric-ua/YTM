...
- [x] one v1.4.35 folder-tree flow opens in-app before Android SAF
...
Phone finding: long remembered-root lists push Add-folder/Cancel off-screen; fixed-footer chooser required before UX-008 acceptance.
