# Termux — YTM Importer v1.4.6 FULL

Archive:

`/sdcard/Download/YTM_Importer_v1.4.6_FULL.zip`
...
rm -rf "$HOME/ytm-v146-temp"
mkdir -p "$HOME/ytm-v146-temp"

unzip -o /sdcard/Download/YTM_Importer_v1.4.6_FULL.zip \
  -d "$HOME/ytm-v146-temp"

cp -a "$HOME/ytm-v146-temp/YTM_Importer_v1.4.6_FULL/." .
rm -rf "$HOME/ytm-v146-temp"
...
git add -A
git commit -m "YTM Importer v1.4.6: unify actions and add service screen"
git push
```
