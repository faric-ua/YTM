...
| BUG-034 | R1 PHONE RETEST FAILED / R2 PHONE RETEST NEEDED | P2 | `History відновлено` and `Відкотити останній Restore?` still disappeared on rotation in R1. R2 removes lifecycle-timing inference: OnDismiss is transient-only; explicit buttons/OnCancel own semantic close. | R1 run `35799736192` / source `c25b9f2a6843caf8790e45467df5bf118d08656d` / `W3R1-1-..W3R1-3-` → R2 static/full preflight |
