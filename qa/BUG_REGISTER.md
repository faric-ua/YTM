...
| BUG-036 | CLOSED — PHONE PASS v1.4.53 | P1 | Durable SEARCH Queue recovery with WAITING_QUOTA passed rotation/restart/unrelated-import and one-track post-reset resume. | v1.4.53 phone QA 2026-09-26 |
| BUG-037 | CLOSED — PHONE RETEST PASS v1.4.53 | P2 | Search 100-call bucket is separated from the non-Search 10,000-unit estimate; phone retest passed. | v1.4.53 phone QA 2026-09-26 |
| BUG-038 | CLOSED — CONTROLLED RETEST PASS v1.4.53 | P1 | History baseline 93 → 94; 0 removed IDs and 0 changed common records. No separate History deletion defect reproduced. | v1.4.53 phone QA 2026-09-26 |
