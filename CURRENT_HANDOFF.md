...
3. Treat Wave 0 BUG-039 stabilization as **W0+ / PHONE PASS** for the normal regression path:
   - Validate Android run `36257890045` PASS on source `9daa9027981551539d2fdfa76d08faa4620aeee6`;
