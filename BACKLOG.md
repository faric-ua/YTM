...
## Current
v1.4.45 — Unified Window Title Emphasis — IMPLEMENTED / PHONE QA NEEDED
...
- UX-022 Unified Window Title Emphasis — IMPLEMENTED v1.4.45 / PHONE QA NEEDED; shared `UiChrome.emphasizedTitle(...)` applies the active theme accent to dialog headers and major full-screen title bars while preserving body/action semantics.
...
- [ ] phone: full-screen title emphasis
- [ ] phone: representative dialog title emphasis
- [ ] phone: Neon + Blue/Green theme smoke
- [ ] phone: rotation/navigation smoke
