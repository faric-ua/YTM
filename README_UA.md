# YTM Importer v0.10.1

Android-застосунок для імпорту списків треків у YouTube / YouTube Music.

## Нове у v0.10.1

Головний екран став компактнішим:

- account info (інформація акаунта) відкривається через `2. Акаунт`;
- quota info (інформація квоти) відкривається через `Квота`;
- постійні великі панелі прибрані;
- список треків отримує значно більше вертикального простору.

## Функції v0.10.0, що залишилися
