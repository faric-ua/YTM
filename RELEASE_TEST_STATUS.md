...
| v1.4.38 | **NOT PHONE-TESTED YET** | Full-screen Import selectors, explicit destructive confirmations, separate safety-snapshot deletion, and shorter mobile action copy implemented. |
