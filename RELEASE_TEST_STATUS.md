...
| v1.4.38 | **NOT PHONE-TESTED YET** | UX-011/012/013: four dynamic Import selectors moved full-screen; destructive local actions use explicit danger confirmation; snapshot deletion separated from rollback success; mobile action labels shortened. |
