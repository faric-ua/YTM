...
| v1.4.40 | **PARTIALLY PHONE-TESTED — RELEASE HISTORY TESTED PATH PASS** | Real-phone QA passed About entry, full release-history rendering/scrolling, readable markdown cleanup, accepted Back behavior, and rotation with scroll-position preservation after the follow-up fix. The oldest visible release is correctly v1.4.6 because that is the oldest `##` section in root `CHANGELOG.md`. This closes UX-016 for the tested Release History scope; it is not a claim of full-app regression coverage. |