...
| v1.4.35 | **NOT PHONE-TESTED YET** | UX-008 Phase 1: remembered SAF tree roots are offered in-app before Android system folder picker; file-level open/create flows remain for later phases. |
