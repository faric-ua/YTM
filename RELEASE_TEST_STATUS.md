...
| v1.4.41 | **NOT PHONE-TESTED YET** | BUG-004 Search 401 propagation/retry-state fix, BUG-009 account-dialog copy fit, BUG-010 quota-preserving Restore, UX-017 filename-to-playlist-name normalization, and UX-018 modal action-position consistency are implemented. Static/preflight and signed-APK phone QA are still required. |